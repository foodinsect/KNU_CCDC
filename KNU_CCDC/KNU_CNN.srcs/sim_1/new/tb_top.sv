...
module tb_top();
    ...
    initial begin
        $readmemh("D:/Git_repo/KNU_CCDC/KNU_CNN.srcs/CNN_MNIST/0_01.txt", pixels);
        clk <= 1'b0;;
        rstn <= 1'b1;
        start_i = 1'b0;
        #10 rstn <= 1'b0;
        ...
        wait(ready==1);
        #30;
        $readmemh("D:/Git_repo/KNU_CCDC/KNU_CNN.srcs/CNN_MNIST/0_02.txt",pixels);
        #10 start_i = 1'b1;
        #10 start_i = 1'b0;
    end
    ...
    initial begin
        ...
        $readmemh("D:/Git_repo/KNU_CCDC/KNU_CNN.srcs/CNN_MNIST/conv1_weight_1.txt", conv1_weight_1);
        $readmemh("D:/Git_repo/KNU_CCDC/KNU_CNN.srcs/CNN_MNIST/conv1_weight_2.txt", conv1_weight_2);
        $readmemh("D:/Git_repo/KNU_CCDC/KNU_CNN.srcs/CNN_MNIST/conv1_weight_3.txt", conv1_weight_3);
        $readmemh("D:/Git_repo/KNU_CCDC/KNU_CNN.srcs/CNN_MNIST/conv1_bias.txt", bias_1);

        // Read weights and biases for conv2
        $readmemh("D:/Git_repo/KNU_CCDC/KNU_CNN.srcs/CNN_MNIST/conv2_weight_11.txt", conv2_weight_11);
        $readmemh("D:/Git_repo/KNU_CCDC/KNU_CNN.srcs/CNN_MNIST/conv2_weight_12.txt", conv2_weight_12);
        $readmemh("D:/Git_repo/KNU_CCDC/KNU_CNN.srcs/CNN_MNIST/conv2_weight_13.txt", conv2_weight_13);
        $readmemh("D:/Git_repo/KNU_CCDC/KNU_CNN.srcs/CNN_MNIST/conv2_weight_21.txt", conv2_weight_21);
        $readmemh("D:/Git_repo/KNU_CCDC/KNU_CNN.srcs/CNN_MNIST/conv2_weight_22.txt", conv2_weight_22);
        $readmemh("D:/Git_repo/KNU_CCDC/KNU_CNN.srcs/CNN_MNIST/conv2_weight_23.txt", conv2_weight_23);
        $readmemh("D:/Git_repo/KNU_CCDC/KNU_CNN.srcs/CNN_MNIST/conv2_weight_31.txt", conv2_weight_31);
        $readmemh("D:/Git_repo/KNU_CCDC/KNU_CNN.srcs/CNN_MNIST/conv2_weight_32.txt", conv2_weight_32);
        $readmemh("D:/Git_repo/KNU_CCDC/KNU_CNN.srcs/CNN_MNIST/conv2_weight_33.txt", conv2_weight_33);
        $readmemh("D:/Git_repo/KNU_CCDC/KNU_CNN.srcs/CNN_MNIST/conv2_bias.txt", bias_2);
    end
